...
/******/ 		return __webpack_require__.p + "" + ({"vendors~vega":"vendors~vega","vega":"vega"}[chunkId]||chunkId) + "." + {"0":"cc98107762fcc28532b3","1":"055322dcf6c2bb19185f","2":"9f854dc15a7a8d2ec003","vendors~vega":"44c7b7e144bbd288b894","vega":"91b98e783d16fd1b9e23"}[chunkId] + ".js"
/******/ 	}
/******/
...
module.exports = __webpack_require__(/*! /Users/thuyttt/Documents/AI-Lab/05_Programming/ocr-research/venv/share/jupyter/lab/staging/build/index.out.js */"ANye");
...
function main() {
  ...
  try {
    ...
    if (isDisabled('@mflevine/jupyterlab_html')) {
      disabled.matches.push('@mflevine/jupyterlab_html');
    } else {
      var module = __webpack_require__(/*! @mflevine/jupyterlab_html/ */ "qo7M");
      var extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@jupyterlab/latex')) {
      disabled.matches.push('@jupyterlab/latex');
    } else {
      module = __webpack_require__(/*! @jupyterlab/latex/lib/index.js */ "lCVc");
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('jupyterlab-jupytext')) {
      ...
      module = __webpack_require__(/*! jupyterlab-jupytext/ */ "d7p3");
      extension = module.default;
...
/******/ });
//# sourceMappingURL=main.841a580fec3d53e2c472.js.map